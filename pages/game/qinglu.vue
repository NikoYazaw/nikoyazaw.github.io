  ...
  <view class="game-container">
    ...
    <view class="start-modal-container" v-if="showStartModal">
      <view class="start-modal-content">
        <view class="start-modal-title">情侣版（仅限于18岁以上使用）</view>
...
export default {
  ...
  data() {
    return {
      ...
      currentMode: 'qinglu', // 当前模式
      boardSize: 62, // 棋盘大小 (0-61共62个格子)
      showModal: false, // 是否显示任务弹窗
  ...
  methods: {
    ...
    // 跳转到游戏玩法页面
    navigateToRules() {
      uni.navigateTo({ url: '/pages/game/rules' });
    },
...
.cell.special {
  background: linear-gradient(135deg, #ff8fab 0%, #ff69b4 100%);
