  ...
  <view class="game-container">
    ...
    <view class="start-modal-container" v-if="showStartModal">
      <view class="start-modal-content">
        <view class="start-modal-title">丝足版（仅限于18岁以上使用）</view>
...
export default {
  ...
  methods: {
    ...
    setSpecialCells(cells) {
      // 在一些位置设置特殊格子 (不使用图标)
      // 调整位置以适应0-60的中间格子
      const specialPositions = [8, 17, 26, 35, 44, 53, 60];
...
.game-board {
  ...
  padding: 10rpx;
  border-radius: 10rpx;
  box-shadow: 0 0 10rpx rgba(46, 139, 87, 0.1);
}
...
.cell.start {
  ...
  box-shadow: 0 0 10rpx rgba(46, 139, 87, 0.3);
}
...
.cell.end {
  ...
  box-shadow: 0 0 10rpx rgba(0, 100, 0, 0.3);
}
